      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    // iconssystemstatusbarlocationHh (0:47)
                  ...
                  Container(
                    // iconssystemstatusbarsignalyao (0:41)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 4.5*fem, 2*fem),
                    width: 16.5*fem,
                    height: 10*fem,
                    child: Image.asset(
                      'assets/page-1/images/icons-system-status-bar-signal-X3d.png',
                      width: 16.5*fem,
                      height: 10*fem,
                    ),
                  ),
                  Container(
                    // iconssystemstatusbarwifiUXZ (0:36)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 5.75*fem, 2*fem),
                    width: 14.25*fem,
                    height: 10*fem,
                    child: Image.asset(
                      'assets/page-1/images/icons-system-status-bar-wifi-ibR.png',
                      width: 14.25*fem,
                      height: 10*fem,
                    ),
                  ),
                  Container(
                    // iconssystemstatusbarbatteryPPd (0:29)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 1.5*fem),
                    width: 26.5*fem,
                    height: 11.5*fem,
                    child: Image.asset(
                      'assets/page-1/images/icons-system-status-bar-battery-tGo.png',
                      width: 26.5*fem,
                      height: 11.5*fem,
                    ),
                  ),
            ...
            Container(
              // autogroup6mttGiK (6eVsYxNyeq1bRp5b676mtT)
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    height: 21*fem,
                    child: Image.asset(
                      'assets/page-1/images/group-7377-1y9.png',
                      width: 21*fem,
                      height: 21*fem,
                    ),
                  ),
            ...
            Container(
              // autogrouph4szoEP (6eVsj2vWzMTCDmTZnwh4sZ)
            ...
            Container(
              // autogroupwpuq3bu (6eVsqnEGyXHVHD2Va1wPuq)
