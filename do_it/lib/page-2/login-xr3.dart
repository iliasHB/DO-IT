        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    // iconssystemstatusbarlocationXj (0:133)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 219.76*fem, 0.96*fem),
                    width: 10.54*fem,
                    height: 10.54*fem,
                    child: Image.asset(
                      'assets/page-1/images/icons-system-status-bar-location-bDR.png',
                      width: 10.54*fem,
                      height: 10.54*fem,
                    ),
                  ),
                  Container(
                    // iconssystemstatusbarsignalS63 (0:127)
                  ...
                  Container(
                    // iconssystemstatusbarwifiYes (0:122)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 5.75*fem, 2*fem),
                    width: 14.25*fem,
                    height: 10*fem,
                    child: Image.asset(
                      'assets/page-1/images/icons-system-status-bar-wifi-4NT.png',
                      width: 14.25*fem,
                      height: 10*fem,
                    ),
                  ),
                  Container(
                    // iconssystemstatusbarbatteryFZH (0:115)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 1.5*fem),
                    width: 26.5*fem,
                    height: 11.5*fem,
                    child: Image.asset(
                      'assets/page-1/images/icons-system-status-bar-battery-ywV.png',
                      width: 26.5*fem,
                      height: 11.5*fem,
                    ),
                  ),
            ...
            Container(
              ...
              height: 40*fem,
              child: Image.asset(
                'assets/page-1/images/header-H19.png',
                width: 40*fem,
                height: 40*fem,
              ),
            ),
            Container(
              // autogrouprvomUB9 (6eVuwtPUzFCF6SonwgrVom)
            ...
            Container(
              // autogroupvqvjEi3 (6eVv5oKxwqe6TfcHeNvQvj)
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 11.5*fem, 24*fem),
              width: 327*fem,
              height: 71*fem,
              child: Stack(
            ...
            Container(
              // autogroupkjtdur7 (6eVvDNwfmbdDTEdUetkjTD)
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    height: 15*fem,
                    child: Image.asset(
                      'assets/page-1/images/group-394-qkK.png',
                      width: 22.03*fem,
                      height: 15*fem,
                    ),
                  ),
            ...
            Container(
              // autogroupo4ebh9h (6eVvLYQQB4XvUjvY3go4Eb)
              ...
              child: Row(
                ...
                children: [
                  Container(
                    // autogroup1nwhRbV (6eVvSYEQc6q5CTz2Ws1nwH)
                  ...
                  Container(
                    // autogroup8ahdtjy (6eVvVY9QpcyeZL1mkT8AHd)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 1*fem),
                    ...
                    child: Center(
                      // ionfingerprintoutlineCEs (0:153)
                      child: SizedBox(
                        width: 26*fem,
                        height: 30*fem,
                        child: Image.asset(
                          'assets/page-1/images/ion-finger-print-outline-sSf.png',
                          width: 26*fem,
                          height: 30*fem,
                        ),
                      ),
            ...
            Container(
              // autogroupshomhSX (6eVvasKryzMLXkWeqGshoM)
