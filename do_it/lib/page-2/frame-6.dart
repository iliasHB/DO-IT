            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        // iconssystemstatusbarlocationnm (0:186)
                        margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 219.76*fem, 0.96*fem),
                        width: 10.54*fem,
                        height: 10.54*fem,
                        child: Image.asset(
                          'assets/page-1/images/icons-system-status-bar-location-Zkb.png',
                          width: 10.54*fem,
                          height: 10.54*fem,
                        ),
                      ),
                      Container(
                        // iconssystemstatusbarsignaltJb (0:180)
                        margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 4.5*fem, 2*fem),
                        width: 16.5*fem,
                        height: 10*fem,
                        child: Image.asset(
                          'assets/page-1/images/icons-system-status-bar-signal-ByR.png',
                          width: 16.5*fem,
                          height: 10*fem,
                        ),
                      ),
                      Container(
                        // iconssystemstatusbarwifibTu (0:175)
                      ...
                      Container(
                        // iconssystemstatusbarbatteryuDh (0:168)
                        margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 1.5*fem),
                        width: 26.5*fem,
                        height: 11.5*fem,
                        child: Image.asset(
                          'assets/page-1/images/icons-system-status-bar-battery-5Tm.png',
                          width: 26.5*fem,
                          height: 11.5*fem,
                        ),
                      ),
                ...
                Container(
                  ...
                  height: 40*fem,
                  child: Image.asset(
                    'assets/page-1/images/header-Am5.png',
                    width: 40*fem,
                    height: 40*fem,
                  ),
                ),
                ...
                Container(
                  // autogroup5dd9pfR (6eVwMvs7WFBeX6ufGe5dD9)
                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 24*fem),
                ...
                Container(
                  // autogroupzyqur6K (6eVwV1VedFUfxCFtjtZYqu)
                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 24*fem),
                  padding: EdgeInsets.fromLTRB(24*fem, 18*fem, 24*fem, 18*fem),
                  width: 327*fem,
                  decoration: BoxDecoration (
                ...
                Container(
                  // autogroupk6mdhcj (6eVwaLg6ncrMvckmpiK6Md)
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        // enteryourmobilenumberHqq (0:191)
                        margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 4*fem, 0*fem),
                        width: 32*fem,
                        height: 24*fem,
                        child: Image.asset(
                          'assets/page-1/images/enter-your-mobile-number-ZGj.png',
                          width: 32*fem,
                          height: 24*fem,
                        ),
                      ),
                ...
                Container(
                  // autogroupjqnkvto (6eVwikbkSxzJrKEE4fjQNK)
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        height: 15*fem,
                        child: Image.asset(
                          'assets/page-1/images/group-394-4kP.png',
                          width: 22.03*fem,
                          height: 15*fem,
                        ),
                      ),
