          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        // iconssystemstatusbarlocationtf (0:186)
                        margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 219.76*fem, 0.96*fem),
                        width: 10.54*fem,
                        height: 10.54*fem,
                        child: Image.asset(
                          'assets/page-1/images/icons-system-status-bar-location-wo5.png',
                          width: 10.54*fem,
                          height: 10.54*fem,
                        ),
                      ),
                      Container(
                        // iconssystemstatusbarsignalmjm (0:180)
                        margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 4.5*fem, 2*fem),
                        width: 16.5*fem,
                        height: 10*fem,
                        child: Image.asset(
                          'assets/page-1/images/icons-system-status-bar-signal-tvj.png',
                          width: 16.5*fem,
                          height: 10*fem,
                        ),
                      ),
                      Container(
                        // iconssystemstatusbarwififq9 (0:175)
                        margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 5.75*fem, 2*fem),
                        width: 14.25*fem,
                        height: 10*fem,
                        child: Image.asset(
                          'assets/page-1/images/icons-system-status-bar-wifi-tEK.png',
                          width: 14.25*fem,
                          height: 10*fem,
                        ),
                      ),
                      Container(
                        // iconssystemstatusbarbatteryAmu (0:168)
                ...
                Container(
                  // autogroup5dd9Vd9 (6eVwMvs7WFBeX6ufGe5dD9)
                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 24*fem),
                ...
                Container(
                  // autogroupzyquX43 (6eVwV1VedFUfxCFtjtZYqu)
                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 24*fem),
                  padding: EdgeInsets.fromLTRB(24*fem, 18*fem, 24*fem, 18*fem),
                  width: 327*fem,
                  decoration: BoxDecoration (
                ...
                Container(
                  // autogroupk6mdx9M (6eVwaLg6ncrMvckmpiK6Md)
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        // enteryourmobilenumberuyh (0:191)
                ...
                Container(
                  // autogroupjqnkkjR (6eVwikbkSxzJrKEE4fjQNK)
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        height: 15*fem,
                        child: Image.asset(
                          'assets/page-1/images/group-394-iDm.png',
                          width: 22.03*fem,
                          height: 15*fem,
                        ),
                      ),
