        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    // iconssystemstatusbarlocationYB (0:84)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 219.76*fem, 0.96*fem),
                    width: 10.54*fem,
                    height: 10.54*fem,
                    child: Image.asset(
                      'assets/page-1/images/icons-system-status-bar-location-LST.png',
                      width: 10.54*fem,
                      height: 10.54*fem,
                    ),
                  ),
                  Container(
                    // iconssystemstatusbarsignal271 (0:78)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 4.5*fem, 2*fem),
                    width: 16.5*fem,
                    height: 10*fem,
                    child: Image.asset(
                      'assets/page-1/images/icons-system-status-bar-signal-Xfm.png',
                      width: 16.5*fem,
                      height: 10*fem,
                    ),
                  ),
                  Container(
                    // iconssystemstatusbarwifiWXy (0:73)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 5.75*fem, 2*fem),
                    width: 14.25*fem,
                    height: 10*fem,
                    child: Image.asset(
                      'assets/page-1/images/icons-system-status-bar-wifi-zGf.png',
                      width: 14.25*fem,
                      height: 10*fem,
                    ),
                  ),
                  Container(
                    // iconssystemstatusbarbatteryp2s (0:66)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 1.5*fem),
                    width: 26.5*fem,
                    height: 11.5*fem,
                    child: Image.asset(
                      'assets/page-1/images/icons-system-status-bar-battery-hU3.png',
                      width: 26.5*fem,
                      height: 11.5*fem,
                    ),
                  ),
            ...
            Container(
              ...
              height: 40*fem,
              child: Image.asset(
                'assets/page-1/images/header-B67.png',
                width: 40*fem,
                height: 40*fem,
              ),
            ),
            Container(
              // autogroupfpb5cDd (6eVtWbSwDMybmbXXmaFPB5)
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    height: 21*fem,
                    child: Image.asset(
                      'assets/page-1/images/group-7377-hkj.png',
                      width: 21*fem,
                      height: 21*fem,
                    ),
                  ),
            ...
            Container(
              // autogroupaufd9FV (6eVtdbFH3uewcGvwKHAufD)
            ...
            Container(
              // autogroupwsf9AgP (6eVtjkjg3sBTWpt5dYWSf9)
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    height: 15*fem,
                    child: Image.asset(
                      'assets/page-1/images/group-394-Xzo.png',
                      width: 22.03*fem,
                      height: 15*fem,
                    ),
                  ),
            ...
            Container(
              // autogroup8kvj7Nf (6eVtskWMHvEzUTdQFn8kvj)
              ...
              child: Row(
                ...
                children: [
                  Container(
                    // autogroupb5i7Ru9 (6eVtzuy5hP9hVxvTeaB5i7)
                  ...
                  Container(
                    // autogroupk3q35Tu (6eVu4fMqU2qRCYTeC4K3Q3)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 1*fem),
            ...
            Container(
              // autogroupny2o5Ew (6eVuBjzNb38SddosfJny2o)
