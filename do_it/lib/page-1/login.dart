        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    // iconssystemstatusbarlocationjh (0:84)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 219.76*fem, 0.96*fem),
                    width: 10.54*fem,
                    height: 10.54*fem,
                    child: Image.asset(
                      'assets/page-1/images/icons-system-status-bar-location-iuD.png',
                      width: 10.54*fem,
                      height: 10.54*fem,
                    ),
                  ),
                  Container(
                    // iconssystemstatusbarsignalE8X (0:78)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 4.5*fem, 2*fem),
                    width: 16.5*fem,
                    height: 10*fem,
                    child: Image.asset(
                      'assets/page-1/images/icons-system-status-bar-signal-SAb.png',
                      width: 16.5*fem,
                      height: 10*fem,
                    ),
                  ),
                  Container(
                    // iconssystemstatusbarwifiwHq (0:73)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 5.75*fem, 2*fem),
                    width: 14.25*fem,
                    height: 10*fem,
                    child: Image.asset(
                      'assets/page-1/images/icons-system-status-bar-wifi-JiK.png',
                      width: 14.25*fem,
                      height: 10*fem,
                    ),
                  ),
                  Container(
                    // iconssystemstatusbarbatteryTGB (0:66)
            ...
            Container(
              ...
              height: 40*fem,
              child: Image.asset(
                'assets/page-1/images/header-Y2j.png',
                width: 40*fem,
                height: 40*fem,
              ),
            ),
            Container(
              // autogroupfpb5fd9 (6eVtWbSwDMybmbXXmaFPB5)
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    height: 21*fem,
                    child: Image.asset(
                      'assets/page-1/images/group-7377-8Wj.png',
                      width: 21*fem,
                      height: 21*fem,
                    ),
                  ),
            ...
            Container(
              // autogroupaufd31R (6eVtdbFH3uewcGvwKHAufD)
            ...
            Container(
              // autogroupwsf9GPy (6eVtjkjg3sBTWpt5dYWSf9)
            ...
            Container(
              // autogroup8kvj4z3 (6eVtskWMHvEzUTdQFn8kvj)
              ...
              child: Row(
                ...
                children: [
                  Container(
                    // autogroupb5i7ogj (6eVtzuy5hP9hVxvTeaB5i7)
                  ...
                  Container(
                    // autogroupk3q3UXy (6eVu4fMqU2qRCYTeC4K3Q3)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 1*fem),
            ...
            Container(
              // autogroupny2ojcK (6eVuBjzNb38SddosfJny2o)
