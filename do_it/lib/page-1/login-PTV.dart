      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    // iconssystemstatusbarlocationRC (0:133)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 219.76*fem, 0.96*fem),
                    width: 10.54*fem,
                    height: 10.54*fem,
                    child: Image.asset(
                      'assets/page-1/images/icons-system-status-bar-location-8rs.png',
                      width: 10.54*fem,
                      height: 10.54*fem,
                    ),
                  ),
                  Container(
                    // iconssystemstatusbarsignalWVD (0:127)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 4.5*fem, 2*fem),
                    width: 16.5*fem,
                    height: 10*fem,
                    child: Image.asset(
                      'assets/page-1/images/icons-system-status-bar-signal-pzj.png',
                      width: 16.5*fem,
                      height: 10*fem,
                    ),
                  ),
                  Container(
                    // iconssystemstatusbarwifiR6P (0:122)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 5.75*fem, 2*fem),
                    width: 14.25*fem,
                    height: 10*fem,
                    child: Image.asset(
                      'assets/page-1/images/icons-system-status-bar-wifi-bAF.png',
                      width: 14.25*fem,
                      height: 10*fem,
                    ),
                  ),
                  Container(
                    // iconssystemstatusbarbatteryvoq (0:115)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 1.5*fem),
                    width: 26.5*fem,
                    height: 11.5*fem,
                    child: Image.asset(
                      'assets/page-1/images/icons-system-status-bar-battery-Pp3.png',
                      width: 26.5*fem,
                      height: 11.5*fem,
                    ),
                  ),
            ...
            Container(
              // autogrouprvomXod (6eVuwtPUzFCF6SonwgrVom)
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    height: 21*fem,
                    child: Image.asset(
                      'assets/page-1/images/group-7377-JqV.png',
                      width: 21*fem,
                      height: 21*fem,
                    ),
                  ),
            ...
            Container(
              // autogroupvqvjhk3 (6eVv5oKxwqe6TfcHeNvQvj)
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 11.5*fem, 24*fem),
              width: 327*fem,
              height: 71*fem,
              child: Stack(
            ...
            Container(
              // autogroupkjtdDkK (6eVvDNwfmbdDTEdUetkjTD)
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    height: 15*fem,
                    child: Image.asset(
                      'assets/page-1/images/group-394-XQB.png',
                      width: 22.03*fem,
                      height: 15*fem,
                    ),
                  ),
            ...
            Container(
              // autogroupo4eb375 (6eVvLYQQB4XvUjvY3go4Eb)
              ...
              child: Row(
                ...
                children: [
                  Container(
                    // autogroup1nwhmHy (6eVvSYEQc6q5CTz2Ws1nwH)
                  ...
                  Container(
                    // autogroup8ahdRNX (6eVvVY9QpcyeZL1mkT8AHd)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 1*fem),
                    ...
                    child: Center(
                      // ionfingerprintoutlineXRZ (0:153)
                      child: SizedBox(
                        width: 26*fem,
                        height: 30*fem,
                        child: Image.asset(
                          'assets/page-1/images/ion-finger-print-outline-jxs.png',
                          width: 26*fem,
                          height: 30*fem,
                        ),
                      ),
            ...
            Container(
              // autogroupshomDpB (6eVvasKryzMLXkWeqGshoM)
