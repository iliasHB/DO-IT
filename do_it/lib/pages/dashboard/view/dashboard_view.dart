...
import 'package:do_it/pages/dashboard/widgets/task.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        //elevation: 0,
          onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => CreateProjectPage())),
